...
r = remote("mercury.picoctf.net", 19860)
alphabet = "lsi28c14ot0vbf7nagh3mpjuxy5kwz6edqr9"
encrypted = "1x5hqlod8x7oa88h0de1b5r6xja5sd"
m = generate_square(alphabet)
decrypted = decrypt_string(encrypted, m)
print(r.recvuntil(b"What is the plaintext message? "))
r.sendline(decrypted.encode())
data = r.recvline()[:-1].decode().split("Congratulations! Here's the flag: ")[1]
print(data)
