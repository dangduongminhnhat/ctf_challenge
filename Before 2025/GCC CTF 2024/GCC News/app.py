...
key = generate_key("daminhat")
n, e = key[0]
n, d = key[1]
signature = generate_signature(str({'daminhat': [True]}), (n, d))
print(signature)

# http://worker05.gcc-ctf.com:14329/news?token=&message=eydkYW1pbmhhdCc6IFtUcnVlXX0=
